...
etransition_table(ismember(etransition_table.names,'Active_Wake to NREM'),'names') =  {'Quiet_Wake to NREM'};
etransition_table(ismember(etransition_table.names,'NREM to Active_Wake'),'names') =  {'NREM to Quiet_Wake'};
%desired groups
